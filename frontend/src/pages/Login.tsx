  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to MedNoteScribe",
      });
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-white text-center max-w-lg p-8">
              <h2 className="text-3xl font-bold mb-4">
                Spend less time on dictation, more time on patient care
              </h2>
              <p className="text-white/80">
                MedNoteScribe helps medical professionals save hours every week on operative note documentation.
              </p>
            </div>
          </div>
        </div>
